class Config:
    ...
    def __init__(self, config_file):
        ...
        self.user_review = config['user_review'].lower() == "true" if 'user_review' in config else True
        self.use_task_gen = config['use_task_gen'].lower() == "true" if 'use_task_gen' in config else True
